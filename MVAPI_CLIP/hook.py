...
class MaskHookLogger(object):
    ...
    def compute_attentions(self, ret):
        # print("compute_attentions was called!")
        # print(f"Layer {self.current_layer}: Entering compute_attentions")  # Debug
        # print(f"Layer {self.current_layer}: Input shape - {ret.shape}")  # Debug
