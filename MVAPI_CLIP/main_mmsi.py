...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="MMSI")
    parser.add_argument("--model_name", type=str, default="ViT-L-14-336")
    parser.add_argument("--batch_size", type=int, default=1)
    parser.add_argument("--layer_index", type=int, default=22)
    parser.add_argument("--range", type=int, nargs = 2, default=(0,2000))
    parser.add_argument("--output_folder", type=str, default = "your/path/MMSI/clipcutoff0.5")
